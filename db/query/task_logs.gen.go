...
func newTaskLog(db *gorm.DB, opts ...gen.DOOption) taskLog {
	...
	_taskLog.Id = field.NewInt64(tableName, "id")
	_taskLog.CreatedAt = field.NewTime(tableName, "created_at")
	_taskLog.UpdatedAt = field.NewTime(tableName, "updated_at")
	_taskLog.IsDeleted = field.NewBool(tableName, "is_deleted")
	_taskLog.TaskCardRecordId = field.NewInt64(tableName, "task_card_record_id")
	_taskLog.Type = field.NewString(tableName, "type")
	_taskLog.LearnStatus = field.NewString(tableName, "learn_status")
	_taskLog.CreatedBy = field.NewInt64(tableName, "created_by")
...
type taskLog struct {
	...
	TaskCardRecordId field.Int64
	Type             field.String
	LearnStatus      field.String
...
func (t *taskLog) updateTableName(table string) *taskLog {
	...
	t.TaskCardRecordId = field.NewInt64(table, "task_card_record_id")
	t.Type = field.NewString(table, "type")
	t.LearnStatus = field.NewString(table, "learn_status")
...
func (t *taskLog) fillFieldMap() {
	...
	t.fieldMap["task_card_record_id"] = t.TaskCardRecordId
	t.fieldMap["type"] = t.Type
	t.fieldMap["learn_status"] = t.LearnStatus
...
type ITaskLogDo interface {
	...
	GetBySearchAndUserId(search string, userId int64) (result []*model.TaskLog, err error)
}

// SELECT * FROM @@table WHERE question LIKE concat("%", @search,"%") OR answer LIKE concat("%", @search,"%") OR created_by = @userId
func (t taskLogDo) GetBySearchAndUserId(search string, userId int64) (result []*model.TaskLog, err error) {
	...
	generateSQL.WriteString("SELECT * FROM task_logs WHERE question LIKE concat(\"%\", ?,\"%\") OR answer LIKE concat(\"%\", ?,\"%\") OR created_by = ? ")
